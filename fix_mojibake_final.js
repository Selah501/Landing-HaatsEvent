...
const startIndex = lines.findIndex(l => l.includes('window.addMasterRow = function'));
const endIndex = lines.findIndex((l, i) => i > startIndex && l.includes('window.renderEventList = function'));
...
`;
    ...
    console.log('Successfully replaced broken text.');
} else {
